    ...
    <nav className="bg-black py-4">
      <div className="container mx-auto flex justify-between items-center px-4 xl:px-0">
        ...
        <div className="flex items-center">
          {/* Social Icons */}
          <a href="https://twitter.com/sharkcattoken" target="_blank" rel="noopener noreferrer" className="text-white px-3">
          ...
          <a href="https://t.me/sharkcatcommunity" target="_blank" rel="noopener noreferrer" className="text-white px-3">
